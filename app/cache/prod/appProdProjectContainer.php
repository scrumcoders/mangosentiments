...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'presta_01', 'user' => 'presta_01_user', 'password' => '!R8tLsNk90', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ec3cb5491c52b0e52f568f9af7f3bb0d913c6276b222bd31d80b2a5679536859');
    ...
    {
        return $this->services['prestashop.core.api.category.repository'] = new \PrestaShopBundle\Entity\Repository\CategoryRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'ms_');
    }
    ...
    {
        return $this->services['prestashop.core.api.feature_attribute.repository'] = new \PrestaShopBundle\Entity\Repository\FeatureAttributeRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'ms_');
    }
    ...
    {
        return $this->services['prestashop.core.api.manufacturer.repository'] = new \PrestaShopBundle\Entity\Repository\ManufacturerRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'ms_');
    }
    ...
    {
        return $this->services['prestashop.core.api.stockmovement.repository'] = new \PrestaShopBundle\Entity\Repository\StockMovementRepository($this, $this->get('doctrine.dbal.default_connection'), $this->get('doctrine.orm.default_entity_manager'), $this->get('prestashop.adapter.legacy.context'), $this->get('prestashop.adapter.image_manager'), 'ms_');
    }
    ...
    {
        return $this->services['prestashop.core.api.supplier.repository'] = new \PrestaShopBundle\Entity\Repository\SupplierRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'ms_');
    }
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('ms_');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('zTHR2ScY6swAY6SirAsk9zPQTr02O6YeE3cQEkAFAWRzxCzEe0uCx1eW');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a2202f838ba27.62128194')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => '',
            'database_name' => 'presta_01',
            'database_user' => 'presta_01_user',
            'database_password' => '!R8tLsNk90',
            'database_prefix' => 'ms_',
            ...
            'secret' => 'zTHR2ScY6swAY6SirAsk9zPQTr02O6YeE3cQEkAFAWRzxCzEe0uCx1eW',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2017-12-02',
            'locale' => 'en-US',
            'cookie_key' => 'wXc1zKQeghUSDvw2vcTiibgCMsmdripXx20eW8XgzFL4auk8Hwq57KKx',
            'cookie_iv' => '8CxT8Hkd',
            'new_cookie_key' => 'def000009cdd432b0d7249eb7757da65bd023483852b4af4de748a9209a7919c61ec30685c0f646e5c51f2c0f8ad01567191d8c226b42c1cae06b12b29c94c34984ed975',
            ...
            'kernel.secret' => 'zTHR2ScY6swAY6SirAsk9zPQTr02O6YeE3cQEkAFAWRzxCzEe0uCx1eW',
